...
if selected == 'Diabetes Prediction':
    ...
    if st.button('Go to Next Page'):
        # Redirect to the next page using an anchor tag
        st.markdown('<a href="next_page.html" target="_blank">Click here to go to the next page</a>', unsafe_allow_html=True)
...
if selected == 'Lungs Cancer Prediction':
    ...
    with col1:
        Gender = st.text_input('Gender') # 0 1
    ...
    with col1:
        ellow_Fingers = st.text_input('Yellow Fingers')
    ...
    with col1:
        rhronic_Disease = st.text_input('Chronic Disease')

    with col2:
        Fatique = st.text_input('Fatique')
    ...
    with col2:
        ASWALLOWING_DIFFICULTY = st.text_input('SWALLOWING DIFFICULTY')

    with col3:
        CHEST_PAIN = st.text_input('CHEST PAIN')

    with col1:
        LUNG_CANCER = st.text_input('LUNG_CANCER')
...
# # Now you can start building your Streamlit app
